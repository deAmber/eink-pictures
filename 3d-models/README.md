...
These files are also published on printables. If you wish to modify the files you can find them on [onShape](https://cad.onshape.com/documents/4913049a9a49f8f4cdaf3a0f/w/25e13eeb061b24291810236e/e/7fa965596a244ea4fc1d81bc?renderMode=0&uiState=6983d51955dd59293dddc37a).
...
The `pi_support` and `battery_holder` can be printed in any colour, but the other parts will be visible so should probably be all printed in a matching colour that either matches your frame or your wall.
